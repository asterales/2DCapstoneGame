...
public class ScriptedEndTurn : ScriptEvent {
    ...
    public override void DoPlayerEvent() {
        ...
        Camera.main.transform.GetComponentInChildren<EndTurn>().GetComponent<SpriteRenderer>().color = Color.yellow;
    }
    ...
    public override void FinishEvent(){
        if (!list.EndEarly) {
            ...
            if(isPlayerEvent){
                Camera.main.transform.GetComponentInChildren<EndTurn>().GetComponent<SpriteRenderer>().color = Color.white;
                player.EndTurn();
